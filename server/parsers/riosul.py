"""
Parser Rio Sul de Xerem — formato SuasVendas (mesmo layout do Zona Sul / Adonai /
...
__cliente_nome__ = "Rio Sul de Xerem"
...
def parse(pdf_bytes, produtos):
    ...
    if itens:
        filiais.append({'filial': razao or 'RIO SUL', 'pedidoNum': pedidoNum, 'cnpj': cnpj,
